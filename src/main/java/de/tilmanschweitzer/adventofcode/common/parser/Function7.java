...
public interface Function7<P1, P2, P3, P4, P5, P6, P7, R> {
	...
	default R apply(Tuple7<P1, P2, P3, P4, P5, P6, P7> tuple) {
		return this.apply(tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(), tuple.getValue5(), tuple.getValue6(), tuple.getValue7());
	}
}
